...
all_inclusive <- modelsummary(list("Pooled" = epi_pool,
                  "Male" = epi_male,
                  "Female" = epi_female),
             stars = T,
...
```{r}
# Externalising behaviour mediator
mediate_model <- lm(external ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age, data = df)
...
```{r}
# Internalising behaviour mediator
mediate_model <- lm(internal ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age, data = df)
full_model <- lm(grimAge_6_resid ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age + 
               internal, data = df)
...
```{r}
# Drug abuse
mediate_model <- lm(ever_drugs ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age, data = df)
full_model <- lm(grimAge_6_resid ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age + 
               ever_drugs, data = df)
...
```{r}
# Cigarettes
mediate_model <- lm(ever_cig ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age, data = df)
full_model <- lm(grimAge_6_resid ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age + 
               ever_cig, data = df)
...
```{r}
# Alcohol
mediate_model <- lm(ever_alcohol ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age, data = df)
full_model <- lm(grimAge_6_resid ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age + 
               ever_alcohol, data = df)
...
```{r}
# Depression
mediate_model <- lm(depression ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age, data = df)
full_model <- lm(grimAge_6_resid ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age + 
               depression, data = df)
...
```{r}
# BMI
mediate_model <- lm(bmi_6 ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age, data = df)
full_model <- lm(grimAge_6_resid ~ ace_36mo + ace_60mo + ace_108mo + ethnic + m_race + m_edu + m_age + 
               bmi_6, data = df)
...
```{r}
# Combined
pov_pool <- lm(grimAge_6_resid ~ recency+ace_108mo+ace_12mo+
...
```{r}
# OLS
pov_male <- lm(grimAge_6_resid ~ ace_12mo + ace_108mo + ace_36mo +
...
```{r}
# Recency
pov_female <- lm(grimAge_6_resid ~ recency + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
```{r}
pov <- modelsummary(list("Pooled" = pov_pool,
                  "Male" = pov_male,
                  "Female" = pov_female),
             stars = T,
             estimate = "{estimate}{stars} [{conf.low}, {conf.high}]",
...
```{r}
# 3 years
stab_pool <- lm(grimAge_6_resid ~ ace_36mo + male + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
stab_male <- lm(grimAge_6_resid ~ ace_36mo + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
```{r}
# 3 years
stab_female <- lm(grimAge_6_resid ~ ace_36mo + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
```{r}
stab <- modelsummary(list("Pooled" = stab_pool,
                  "Male" = stab_male,
                  "Female" = stab_female),
             stars = T,
             estimate = "{estimate}{stars} [{conf.low}, {conf.high}]",
...
deprive_pool <- lm(grimAge_6_resid ~ ace_12mo + male + ethnic + m_race + m_edu + m_age,
             data = df)
...
```{r}
# 108mo + 60mo years
deprive_male <- lm(grimAge_6_resid ~ ace_108mo + ace_60mo +  ethnic + m_race + m_edu + m_age,
             data = df)
```
...
```{r}
# 36mo + 12mo 
deprive_female <- lm(grimAge_6_resid ~ ace_12mo + ace_36mo + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
```{r}
deprive <- modelsummary(list("Pooled" = deprive_pool,
                  "Male" = deprive_male,
                  "Female" = deprive_female),
             stars = T,
             estimate = "{estimate}{stars} [{conf.low}, {conf.high}]",
             coef_rename = c("ace_36mo" = "Age 3 sensitive period",
                             "ace_108mo" = "Age 9 sensitive period",
...
threat_pool <- lm(grimAge_6_resid ~ ace_36mo + male + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
threat_male <- lm(grimAge_6_resid ~ ace_36mo + accumulation + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
```{r}
# Ace 36mo
threat_female <- lm(grimAge_6_resid ~ ace_36mo + ethnic + m_race + m_edu + m_age,
             data = df)
```
...
```{r}
threat <- modelsummary(list("Pooled" = threat_pool,
                  "Male" = threat_male,
                  "Female" = threat_female),
             stars = T,
             estimate = "{estimate}{stars} [{conf.low}, {conf.high}]",
             coef_rename = c("ace_36mo" = "Age 3 sensitive period",
                             "ace_108mo" = "Age 9 sensitive period",
